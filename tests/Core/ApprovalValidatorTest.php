...
class ApprovalValidatorTest extends TestCase
{
    ...
    /** @test */
    public function validateApproval_validateRejection_validatePending_always_returns_true_by_default()
    {
    ...
    /** @test */
    public function validateRejectionReason_returns_true_if_allowedReasons_is_empty()
    {
        $this->assertTrue($this->validator->validateRejectionReason('spam', []));
    }

    /** @test */
    public function validateRejectionReason_returns_true_if_reason_is_allowed()
    {
    ...
    /** @test */
    public function validateRejectionReason_returns_false_if_reason_is_not_allowed()
    {
        $allowed = ['spam' => 'Spam', 'other' => 'Other'];
    ...
    /** @test */
    public function canApprove_canReject_canSetPending_always_returns_true_by_default()
    {
    ...
    /** @test */
    public function validateModelConfiguration_returns_true_for_default_config()
    {
        $this->assertTrue($this->validator->validateModelConfiguration($this->post));
    }

    /** @test */
    public function validateModelConfiguration_returns_false_for_invalid_mode()
    {
    ...
    /** @test */
    public function validateModelConfiguration_returns_false_for_invalid_rejection_reasons()
    {
